...
public final class SensitiveInfoUtils {
    ...
    public static void main(String[] args) {
        System.out.println(chineseName("张家界"));
        System.out.println(idCard("412828199511260197"));
        System.out.println(mobilePhone("17521003012"));
        System.out.println(email("machunhuimail@foxmail.com"));
    }
